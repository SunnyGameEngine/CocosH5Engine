...
engine.Stats = engine.Object.extend({
  pstats: null,
  ...
  ctor: function () {
    ...
    var AutoMaxGraph = (function (Graph$$1) {
      ...
      if (Graph$$1) AutoMaxGraph.prototype = Graph$$1;
    ...
    var ThresholdGraph = (function (Graph$$1) {
      ...
      if (Graph$$1) ThresholdGraph.prototype = Graph$$1;
    ...
    var RangedGraph = (function (Graph$$1) {
      ...
      if (Graph$$1) RangedGraph.prototype = Graph$$1;
    ...
    var PerfCounter = (function (Counter$$1) {
      ...
      if (Counter$$1) PerfCounter.prototype = Counter$$1;
    ...
    var MemoryCounter = (function (Counter$$1) {
      ...
      if (Counter$$1) MemoryCounter.prototype = Counter$$1;
